...
let g:which_key_map.m = {
      \ 'name' : '+mark' ,
      \ 'c' : ['<Plug>BookmarkClear', 'clear bookmark'],
      \ 'x' : ['<Plug>BookmarkClearAll', 'clear bookmark all'],
      \ 'a' : ['<Plug>BookmarkAnnotate', 'annotate bookmark'],
      \ 'p' : ['<Plug>BookmarkPrev', 'prev bookmark'],
      \ 'n' : ['<Plug>BookmarkNext', 'next bookmark'],
      \ 'l' : ['<Plug>BookmarkShowAll', 'list bookmark'],
